...
const Winner = ({ projects }) => {
        ...
        const openModal = (project) => {
            if (project) {
                ...
                document.getElementById('modal2-description').textContent = project.description;
                console.log(project.ytLink);
                document.getElementById('modal2-video').src = project.ytLink.replace('watch?v=', 'embed/');
        ...
        useEffect(() => {
            ...
            return () => {
                document.getElementById('close2').removeEventListener('click', closeModal);
            ...
            <div>
                ...
                <section className="winner">
                    ...
                    <div className="winner-content">
                        ...
                        <div className="winner-description">
                            ...
                            <button className="card-button" onClick={() => openModal(champion)}>More</button>
                        </div>
                    </div>
                </section>
                            ...
                            <section className="runner-up">
                                ...
                                <div className="runner-up-content">
                                    ...
                                    <div className="runner-up-description">
                                        ...
                                        <button className="card-button" onClick={() => openModal(firstRunnerUp)}>More</button>
                                    </div>
                                </div>
                            </section>
                        )}
                            ...
                            <section className="runner-up">
                                ...
                                <div className="runner-up-content">
                                    ...
                                    <div className="runner-up-description">
                                        ...
                                        <button className="card-button material-symbols-rounded" onClick={() => openModal(secondRunnerUp)}>More</button>
                                    </div>
                                </div>
                            </section>
                        )}
                ...
                <div className="modal2" id="modal2" style={{ display: 'none' }}>
                    <div className="modal2-content">
                        <span className="close2" id="close2">&times;</span>

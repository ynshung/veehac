    ...
    <div className="container">
      ...
      <div className="project-submission__body">
        ...
        <form id="project-submission-form" onSubmit={handleSubmit}>
          <div>
            <div className="project-submission__full-width-underline">
          ...
          <div>
            ...
            <div className="project-submission__rectangle-small">
              Maximum size limit: 10MB
            </div>
            <label
              htmlFor="slide-file"
              className="project-submission__rectangle-big"
            >
              <i className="fa-solid fa-upload"></i>
              <p style={{ margin: 0 }}>Click to Upload Slide</p>
              <p style={{ margin: 0 }}>Accepted File Type: PDF & PPT</p>
              <p id="slide-file-name" className="project-submission__file-name">
                File name: {slideFileName}
              </p>
              <input
                id="slide-file"
                name="slide_file"
